...
import { Search, MoreHorizontal, UserPlus, Ban, CheckCircle, Edit, Trash2 } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function ManageUsersPage() {
  ...
  const confirmBan = () => {
    setUsers(
      users.map((user) =>
        user.id === selectedUser.id ? { ...user, status: user.status === "active" ? "banned" : "active" } : user,
      ),
    )
      ...
      <Dialog open={isBanDialogOpen} onOpenChange={setIsBanDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant={selectedUser?.status === "banned" ? "default" : "destructive"} onClick={confirmBan}>
